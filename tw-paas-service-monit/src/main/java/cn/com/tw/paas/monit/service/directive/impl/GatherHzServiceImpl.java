...
import cn.com.tw.paas.monit.service.directive.GatherHzService;
 ...
 */
@Service
public class GatherHzServiceImpl implements GatherHzService {

	private static Logger logger = LoggerFactory.getLogger(GatherHzServiceImpl.class);
	...
	public PageCmdResult gatherHz(String netEquipAddr,CmdCallBack callback,String time) {
		...
		inn1 = CmdInnEXEUtil.gatherHzSetInnExe(commandExe, PriceEnum.gatherHz, terminalEquip, 1,new Byte("10"),time);
		inns.add(inn1);
