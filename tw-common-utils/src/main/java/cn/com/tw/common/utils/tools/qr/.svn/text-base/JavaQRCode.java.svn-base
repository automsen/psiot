package cn.com.tw.common.utils.tools.qr;
...
public class JavaQRCode {
     ...
     * @param size 二维码尺寸 
     */ 
    public InputStream encoderQRCode(String content, String imgType, int size) {  
...
//        String imgPath = "e:/QRCodeTest/Michael_QRCode.png";  
//        String encoderContent = "http://www.baidu.com";
//        String num = "超级";
//        String all = num+"\n"+encoderContent;
//        javaQRCode handler = new javaQRCode();  
//        handler.encoderQRCode(all, imgPath, "png");  
//      try {  
