...
import cn.com.tw.paas.monit.service.directive.GetCollectHzService;
...
@Service
public class GetCollectHzServiceImpl implements GetCollectHzService{
	 ...
	 */
	@Override
	public PageCmdResult getCollectHz(String netEquipAddr, CmdCallBack callback) {
		...
		inn1 = CmdInnEXEUtil.getGatherHzInnExe(commandExe, PriceEnum.getGatherHz, terminalEquip, 1,new Byte("10"));
		inns.add(inn1);
