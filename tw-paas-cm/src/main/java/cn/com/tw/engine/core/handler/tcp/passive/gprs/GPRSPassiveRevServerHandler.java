...
@Sharable
public class GPRSPassiveRevServerHandler extends ChannelInboundHandlerAdapter {
	
	private static Logger logger = LoggerFactory.getLogger(GPRSPassiveRevServerHandler.class);
	...
	public GPRSPassiveRevServerHandler(){
