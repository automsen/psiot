...
import cn.com.tw.saas.serv.service.callback.SwitchOffService;
 ...
 */
@Service
public class SwitchOffServiceImpl extends AbstractHandelService implements SwitchOffService {

	private static Logger logger = LoggerFactory.getLogger(SwitchOffServiceImpl.class);
